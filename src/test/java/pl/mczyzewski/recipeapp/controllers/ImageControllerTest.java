...
public class ImageControllerTest {
    ...
    public void renderingImageFromDB() throws Exception {
        ...
        Byte[] batesBoxed = new Byte[s.getBytes().length];

        int i = 0;

        for (byte primByte : s.getBytes()) {
            batesBoxed[i++] = primByte;
        }

        command.setImage(batesBoxed);
    ...
    @Test
    public void testGetImageNumberFormException() throws Exception{

        mockMvc.perform(get("/recipe/dada/recipeimage"))
